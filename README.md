...
| 2.0.3-SHAPSHOT | alibaba dubbo2.6.0+<br>apache dubbo2.7.6+ |  :white_check_mark: 是 | :white_check_mark: 有，[示例文档](swagger-dubbo-example/dubbo-provider) | :white_check_mark: 有，[示例文档](swagger-dubbo-example/dubbo-provider-springboot)<br>swagger调用支持body（仅单个对象） |
